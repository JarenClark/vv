        ...
        @if ($steps && count($steps) > 0)
            <ul class="max-w-xl mx-auto space-y-2 mt-8">
                ...
                @foreach ($steps as $step)
                    <li data-aos="fade-up" data-aos-delay="{!! $idx * 25 !!}"
                        class="rounded-[10px] bg-blue-grey p-2 flex space-x-4 items-center">
                        <div class="bg-white rounded-[10px] p-4 flex items-center justify-center">
                            <div class="text-blue-main font-bold text-2xl">{!! $idx > 8 ? null : 0 !!}{!! $idx + 1 !!}
                            </div>
                        </div>
                        <div class="py-2 pr-8">
                            <h4>{!! $step['step'] !!}</h4>
