        ...
        'meta_query' => [
            [
                ...
                <li class="flex items-center justify-between space-x-2">
                    ...
                    <div class="w-3 h-3 {!! $companion_content->found_posts > 0 ? 'text-green-500' : 'text-red-500' !!}">
                        @includeWhen($companion_content->found_posts > 0, 'icons.circle-check', [
                            'classes' => 'w-4 h-4',
                        ])
                        @includeWhen($companion_content->found_posts == 0, 'icons.circle-x', [
                            'classes' => 'w-4 h-4',
                        ])
                    </div>
